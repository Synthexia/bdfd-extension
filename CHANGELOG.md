...
-   [Auto Completions] Updated auto completions code. Now they are (finally) smooth and stable. There will be no more discomfort that was there before.
-   [Local Data] Fixed some critical issues appear when directories with bot data are deleted or their parent.

### 3.1.2

-   [Sync Feature] Fixed saving commands on some environments
